...
public class RecyclerView_chat_user_adapter   extends RecyclerView.Adapter<com.arbutus.upkeep.chat_system.RecyclerView_chat_user_adapter.MyViewHolder>
{
    ...
    public void onBindViewHolder(MyViewHolder holder, int position)
    {
        ...
        holder.linear_members.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                com.arbutus.upkeep.chat_system.chat_screen.Chat_Screen_Fragment home_fragment = new com.arbutus.upkeep.chat_system.chat_screen.Chat_Screen_Fragment();
